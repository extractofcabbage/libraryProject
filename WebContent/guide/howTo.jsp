...
<body class="w3-light-grey">
    ...
    <div class="w3-col m12">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>도서 검색</h2>
        <div class="w3-container">
          <h5 class="w3-opacity">
        ...
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>대여 및 반납</h2>
        <div class="w3-container">
          <h5 class="w3-opacity">
        ...
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>규정</h2>
        <div class="w3-container">
          <h5 class="w3-opacity">
