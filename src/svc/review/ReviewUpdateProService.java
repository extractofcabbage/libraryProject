...
public class ReviewUpdateProService {
	public boolean isArticleWriter(int no, String email) throws Exception {
		...
		isArticleWriter = reviewDAO.isWriter(no, email); // 본인 확인
		
		close(con);
		
		return isArticleWriter;
	}
	public boolean updateArticle(ReviewBean boardBean) {
		...
		int updateCount = reviewDAO.updateArticle(boardBean); // 글 수정 처리(결과를 int형으로 전달받음)
